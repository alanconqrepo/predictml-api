...
def test_send_webhook_success_200():
...
def test_send_webhook_success_201():
...
def test_send_webhook_http_4xx_logged_no_raise():
...
def test_send_webhook_http_5xx_logged_no_raise():
...
def test_send_webhook_connection_error_logged():
...
def test_send_webhook_timeout_logged():
...
def test_send_webhook_sends_json_payload():
...
def test_send_webhook_uses_correct_url():
