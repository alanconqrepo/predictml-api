    ...
    async with _TestSessionLocal() as db:
        ...
        if not existing:
            meta_bin = ModelMetadata(
                ...
                version="1.0",
                minio_bucket="models",
                minio_object_key="perf_clf_binary/v1.0.pkl",
                classes=[0, 1],
                is_active=True,
                is_production=True,
            )
        ...
        if not existing:
            meta_multi = ModelMetadata(
                ...
                version="1.0",
                minio_bucket="models",
                minio_object_key="perf_clf_multi/v1.0.pkl",
        ...
        if not existing:
            meta_reg = ModelMetadata(
                ...
                version="1.0",
                minio_bucket="models",
                minio_object_key="perf_regression/v1.0.pkl",
                classes=None,
                is_active=True,
                is_production=True,
            )
            ...
            if not existing:
                db.add(
                    ModelMetadata(
                        ...
                        version="1.0",
                        minio_bucket="models",
                        minio_object_key="perf_empty/v1.0.pkl",
                        is_active=True,
                        is_production=True,
                    )
                )
