...
class TestGetGlobalMonitoringStats:
    @pytest.mark.asyncio
    async def test_returns_empty_list_when_no_predictions_in_period(self):
    ...
    @pytest.mark.asyncio
    async def test_aggregates_predictions_by_model_name(self):
    ...
    @pytest.mark.asyncio
    async def test_calculates_error_rate_correctly(self):
    ...
    @pytest.mark.asyncio
    async def test_excludes_shadow_from_production_count(self):
...
class TestGetAccuracyDrift:
    @pytest.mark.asyncio
    async def test_returns_empty_when_no_observed_results(self):
    ...
    async def test_returns_daily_accuracy(self):
        ...
        await _insert_observed_result(model, "drift_obs_2", "cat", timestamp=ts)  # incorrect
...
class TestGetFeatureProductionStats:
    @pytest.mark.asyncio
    async def test_returns_empty_when_no_predictions(self):
    ...
    @pytest.mark.asyncio
    async def test_aggregates_numeric_features(self):
        """Prédictions avec features numériques → stats calculées."""
        model = f"{MODEL_A}_feat_stats"
        # Insérer 3 prédictions récentes avec des features numériques
        for i in range(3):
            await _insert_prediction(
                model,
...
class TestGetModelVersionStatsRange:
    @pytest.mark.asyncio
    async def test_returns_stats_per_version(self):
    ...
    @pytest.mark.asyncio
    async def test_returns_empty_for_unknown_model(self):
...
class TestGetModelPredictionsTimeseries:
    @pytest.mark.asyncio
    async def test_returns_daily_timeseries(self):
...
class TestGetModelRecentErrors:
    @pytest.mark.asyncio
    async def test_returns_last_n_error_messages(self):
    ...
    @pytest.mark.asyncio
    async def test_deduplicates_error_messages(self):
