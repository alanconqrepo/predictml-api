"""
upload_iris_LogisticRegression_uploaded.py — Iris v1.3.0 (LogisticRegression) — uploadé uniquement
====================================================================================================

Upload iris-classifier v1.3.0 avec un Pipeline StandardScaler + LogisticRegression.
...
DESCRIPTION   = "Pipeline StandardScaler + LogisticRegression iris (v1.3.0) — modèle linéaire, C=0.5"
...
if not os.path.exists(TRAIN_SCRIPT_PATH):
    print(f"❌  train_iris_LogisticRegression.py introuvable : {TRAIN_SCRIPT_PATH}")
    sys.exit(1)
...
if result.returncode != 0:
    print("❌  train_iris_LogisticRegression.py a échoué :")
    print(result.stderr)
...
# ── 4. PATCH → tag uniquement (pas de production, pas de deployment_mode) ────
...
print(f"\n   → iris-classifier v{MODEL_VERSION} uploadé mais inactif")
