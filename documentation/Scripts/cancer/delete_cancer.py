"""
delete_cancer.py — Nettoyage complet du modèle cancer-classifier via l'API PredictML
======================================================================================
...
Usage :
  python delete_cancer.py                     # dry-run -> affiche ce qui sera supprimé
  python delete_cancer.py --yes               # supprime sans confirmation
...
if not API_TOKEN:
    ...
    print("    Lancez : API_TOKEN=<votre_token> python delete_cancer.py [--yes]")
    sys.exit(1)
...
print("  ETAPE 1 — Purge des prédictions…")
...
print()
print(f"  ETAPE 2 — Suppression de toutes les versions de '{MODEL_NAME}'…")
