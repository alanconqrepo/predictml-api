"""
train_wine_RandomForest.py — PredictML retraining script — Wine (RandomForest)
========================================================================================

Model    : RandomForestRegressor (n_estimators=150, max_depth=8, min_samples_leaf=2)
Dataset  : scikit-learn Wine — regression (target: alcohol content)
Differences vs v1.0.0 GradientBoosting:
  - RandomForest instead of GradientBoosting (independent trees, no boosting)
  - Faster training, reduced variance
